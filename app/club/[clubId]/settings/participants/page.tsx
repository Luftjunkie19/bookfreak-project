...
function page({}: Props) {
  return (
      <div className='w-full flex gap-6 sm:h-[calc(100vh-3rem)] xl:h-[calc(100vh-3.5rem)]  flex-col overflow-y-auto p-3'>
        ...
        <p className='text-white text-2xl flex items-center gap-2'><FaCodePullRequest /> Requests/Reports from Members</p>
  ...
  <Button additionalClasses='text-red-400  text-3xl' type='transparent'><GiExitDoor/></Button>
            ...
            <div className="flex flex-col gap-1">
        <p className='text-white text-2xl flex gap-2 items-center'><FaUsers /> Competition's Members</p>
