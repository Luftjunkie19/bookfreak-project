...
function FilterBar({filterBarContent, sortingBarContent }: Props) {
  ...
  return (
    <div className={` sm:h-[calc(100vh-3rem)] xl:h-[calc(100vh-3.5rem)] sm:max-w-40 xl:max-w-xs w-full ${location.includes('search') ? 'sm:hidden lg:flex': 'hidden'} z-40 py-4 px-6  bg-dark-gray  flex-col gap-6 rounded-r-xl border-r-2 border-primary-color`}>          
