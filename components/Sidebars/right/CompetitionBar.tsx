...
function CompetitionBar() {
    ...
    return (
        <div className={`sm:h-[calc(100vh-3rem)] xl:h-[calc(100vh-3.5rem)] bg-dark-gray ${!pathname.includes('settings') ? 'sm:hidden lg:flex' : 'hidden'} border-l-2 border-primary-color flex-col sm:w-fit 2xl:max-w-xs p-2 2xl:w-full`}>
