...
type Props = {
  bookCover: string, additionalClasses?:string, pages: number, author: string, bookId: string, title: string, bookCategory: string, type: 'transparent' | 'blue' | 'black' | 'dark' | 'white'
 }

function Book({ bookCover, additionalClasses, pages, author, title, bookCategory, bookId, type }: Props) {
  return (
