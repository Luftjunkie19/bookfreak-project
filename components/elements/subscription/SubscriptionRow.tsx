  ...
  return (
      <div className='flex self-center flex-col gap-2 items-center w-full justify-center max-w-7xl p-4'>
          ...
          <div className="w-full flex max-w-6xl justify-between gap-4 items-center">
              ...
              <SubscriptionPlan subscriptionPeriod='month' bgType='dark' isMonth={false} price={5.99} offerName={'FOTM Plan'} />
                        <SubscriptionPlan subscriptionPeriod='year' bgType='white' isMonth={false} price={5.99} offerName={'FOTY Plan'}/>
</div>
    </div>
  )
}
