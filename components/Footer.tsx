...
function Footer() {
  ...
  return (
    <footer className={`footer p-10 ${pathname.includes('/chat/') || pathname.includes('/club/') || pathname.includes('/competition/')  && 'hidden'} ${isDarkModed ? " bg-primary-color" : "bg-secondary-color"} text-white`}>
      <nav>
