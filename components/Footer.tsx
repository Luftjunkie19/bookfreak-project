...
function Footer() {
  ...
  return (
    <footer className={` p-10 ${pathname.includes('/chat/') || pathname.includes('/club/') || pathname.includes('/competition/')  ? 'hidden' : 'footer'} ${isDarkModed ? " bg-primary-color" : "bg-secondary-color"} text-white`}>
      <nav>
