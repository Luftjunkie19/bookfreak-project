...
function Footer() {
  ...
  return (
    <footer className={`sm:mb-7 lg:mb-14 p-10 ${includesElements('/chat/') || includesElements('/played') || includesElements('/profile/settings') || includesElements('/profile/dashboard') || includesElements('/club/') || includesElements('/competition/') || (includesElements('/competition/') && !includesElements('/form/'))  ? 'hidden' : 'footer'} ${!isDarkModed ? " bg-primary-color" : "bg-secondary-color"} text-white`}>
      <nav>
