...
function ModalComponent({isOpen,onOpenChange,modalTitle, modalSize, modalBodyContent, modalFooterContent }: Props) {
  return (
    <Modal size={modalSize} backdrop='blur' classNames={{
