...
function HeroSection({}: Props) {
  return (
    <div className=' sm:flex-col-reverse lg:flex-row lg:mx-auto lg:m-0 lg:max-w-4xl xl:max-w-5xl 2xl:max-w-7xl w-full flex lg:items-center lg:justify-between p-4'>
        ...
        <Lottie className='sm:max-w-xs lg:max-w-56 xl:max-w-64 2xl:max-w-sm w-full' animationData={lottieAnimation} />
    </div>
  )
}
